...
\frametitle{Python - Valeurs et philosophie}
  ...
  \begin{llist}
    ...
    \mode<article>{\linebreak La philosophie du langage Python et des règles qui l'accompagnent tendent à programmer de manière cohérente et élégante emmenant par là même une grande lisibilité.}
  \end{llist}
\end{frame}
